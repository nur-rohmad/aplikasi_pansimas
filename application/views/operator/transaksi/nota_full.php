        ...
        <div class="row tabel">
            <table>
                <tr>
                    ...
                    <td>: <?= strtoupper($result['id_pelanggan']); ?></td>
                </tr>
                <tr>
                    <td class="label">Nama Pelanggan</td>
                    <td>: <?= strtoupper($result['name_pelanggan']); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td></td>
                    <td style="padding-left: 1em;">RW. 0<?= $result['rw_pelanggan']; ?>,
                        <?php if ($result['rt_pelanggan'] >= 10) : ?>
                            RT. <?= $result['rt_pelanggan']; ?>
                        <?php else : ?>
                            RT. 0<?= $result['rt_pelanggan']; ?>
                    </td>
                <?php endif; ?></td>
                </tr>
                <tr>
                    <td class="label">Tagihan Bulan</td>
                    <td>: <?= format_indo($result['tanggal_transaksi']) ?></td>
                </tr>


                <tr>
                    <td class="label">Stand Meter</td>
                    <td>: <?= $result['start_meter'] ?> M<sup>3</sup> - <?= $result['end_meter'] ?> M<sup>3</sup> </td>
                </tr>
                <tr>
                    <td class="label">Jumlah Pemakaian </td>
                    <td>: <?= $result['jumlah_meteran'] ?> M<sup>3</sup> </td>
                </tr>
                <tr>
                    <td class="label">Biaya Meteran</td>
                    <td>: <?= $result['jumlah_meteran'] ?> x Rp. <?= number_format($biaya_meter['jumlah_tagihan'], 0, ',', '.') ?> </td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="2">: Rp. <?= number_format($result['biaya_pemakaian'], 0, ',', '.'); ?></td>
                </tr>
                <tr>
                ...
                <td colspan="2">
                    <div class="lunas">
                        <span><u>LUNAS</u></span>
                        <span class="tgl">Tanggal : <?= format_tanggal_indo($result['waktu_bayar']) ?></span>
                    </div>
                </td>
            </tr> -->
                <tr>
