                     ...
                     <div class="card-header">
                         <div class="row">
                             ...
                             <div class="col-6 text-right">
                                 <a href="<?= base_url('pelanggan/pengaduan') ?>" class="btn btn-danger "><i class="fas fa-chevron-left mr-2"></i>Kembali</a>
                             </div>
                         </div>
                     </div>
                     <!-- /.card-header -->
                     ...
                     <form action="<?= base_url('operator/pengaduan/prosess_respone_pengaduan') ?>" method="POST">
                         <div class="card-body">
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                         <label for="selectPortal">Respone Pengaduan </label>
                                         <textarea class="form-control" name="respone_pengaduan" rows="10" placeholder="Masukkan Respone Pengaduan" readonly><?= $rs_pengaduan['respone_pengaduan'] ?></textarea>
                                     </div>
                                     <div class="form-group">
                                         <label for="selectPortal">Status Pengaduan </label>
                                         <select name="status_pengaduan" id="" class="form-control select-2" data-placeholder="Ubah Status Pengaduan" disabled>
                                             <option value=""></option>
